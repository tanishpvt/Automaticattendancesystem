        ...
        def mark_attendance(name):
            ...
            if self.ClockInButton.isChecked():
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            buttonReply = QMessageBox.question(self, 'Welcome ' + name, 'Are you want to In?',
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            buttonReply = QMessageBox.question(self, 'Cheers ' + name, 'Are you want to Out?',
                                                              QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
                            if buttonReply == QMessageBox.Yes:
                                date_time_string = datetime.datetime.now().strftime("%d/%m/%y %H:%M:%S")
                                f.writelines(f'\n{name},{date_time_string},Out Time')
