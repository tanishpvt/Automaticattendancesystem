    ...
    package com.example.automaticattendancesystem.OnBoardingScreen;
...
import com.example.automaticattendancesystem.OTP.SendOTP;
        ...
        next_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentPage==mDots.length-1){
                    ...
                    editor.apply();
                    startActivity(new Intent(intropage.this, SendOTP.class));
                }
                else {
